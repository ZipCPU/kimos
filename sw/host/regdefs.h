...
//
// CmdLine:	autofpga -I / -d -o . allclocks.txt clkcheck.txt global.txt crossbus.txt icape.txt version.txt pic.txt pwrcount.txt rtccount.txt spio.txt exconsole.txt wbuuart.txt wbuarbiter.txt bkram.txt flash.txt flashcfg.txt ddr3.txt mem_sdram_only.txt mem_flash_sdram.txt wbperf.txt zipmaster.txt mdio.txt meganet.txt protocols.txt eth0bus.txt sdio.txt ramscope.txt flashscope.txt mem_flash_bkram.txt mem_bkram_only.txt xdc.txt i2ccpu.txt
//
...
#define	R_RAMSCOPE        	0x08000600	// 08000600, wbregs names: RAMSCOPE
#define	R_RAMSCOPED       	0x08000604	// 08000600, wbregs names: RAMSCOPED
// CONSOLE registers
#define	R_CONSOLE_FIFO    	0x08000704	// 08000700, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX  	0x08000708	// 08000700, wbregs names: RX, RXUART
#define	R_CONSOLE_UARTTX  	0x0800070c	// 08000700, wbregs names: TX, TXUART
// FPGA CONFIG REGISTERS: 0x4e0-0x4ff
#define	R_CFG_CRC         	0x08000800	// 08000800, wbregs names: FPGACRC
#define	R_CFG_FAR         	0x08000804	// 08000800, wbregs names: FPGAFAR
#define	R_CFG_FDRI        	0x08000808	// 08000800, wbregs names: FPGAFDRI
#define	R_CFG_FDRO        	0x0800080c	// 08000800, wbregs names: FPGAFDRO
#define	R_CFG_CMD         	0x08000810	// 08000800, wbregs names: FPGACMD
#define	R_CFG_CTL0        	0x08000814	// 08000800, wbregs names: FPGACTL0
#define	R_CFG_MASK        	0x08000818	// 08000800, wbregs names: FPGAMASK
#define	R_CFG_STAT        	0x0800081c	// 08000800, wbregs names: FPGASTAT
#define	R_CFG_LOUT        	0x08000820	// 08000800, wbregs names: FPGALOUT
#define	R_CFG_COR0        	0x08000824	// 08000800, wbregs names: FPGACOR0
#define	R_CFG_MFWR        	0x08000828	// 08000800, wbregs names: FPGAMFWR
#define	R_CFG_CBC         	0x0800082c	// 08000800, wbregs names: FPGACBC
#define	R_CFG_IDCODE      	0x08000830	// 08000800, wbregs names: FPGAIDCODE
#define	R_CFG_AXSS        	0x08000834	// 08000800, wbregs names: FPGAAXSS
#define	R_CFG_COR1        	0x08000838	// 08000800, wbregs names: FPGACOR1
#define	R_CFG_WBSTAR      	0x08000840	// 08000800, wbregs names: WBSTAR
#define	R_CFG_TIMER       	0x08000844	// 08000800, wbregs names: CFGTIMER
#define	R_CFG_BOOTSTS     	0x08000858	// 08000800, wbregs names: BOOTSTS
#define	R_CFG_CTL1        	0x08000860	// 08000800, wbregs names: FPGACTL1
#define	R_CFG_BSPI        	0x0800087c	// 08000800, wbregs names: FPGABSPI
// Meganet register definitions
#define	R_ETH0_RXCMD      	0x08000900	// 08000900, wbregs names: ETH0RX
#define	R_ETH0_TXCMD      	0x08000904	// 08000900, wbregs names: ETH0TX
#define	R_ETH0_MACHI      	0x08000908	// 08000900, wbregs names: ETH0MACHI
#define	R_ETH0_MACLO      	0x0800090c	// 08000900, wbregs names: ETH0MACLO
#define	R_ETH0_IPADDR     	0x08000910	// 08000900, wbregs names: ETH0IPADDR, ETH0IP
#define	R_ETH0_RXMISS     	0x08000914	// 08000900, wbregs names: ETH0MISS
#define	R_ETH0_RXERR      	0x08000918	// 08000900, wbregs names: ETH0ERR
#define	R_ETH0_RXCRC      	0x0800091c	// 08000900, wbregs names: ETH0CRCER
#define	R_ETH0_DBGSEL     	0x08000920	// 08000900, wbregs names: ETH0DBGSL
#define	R_ETH0_RXPKTS     	0x08000920	// 08000900, wbregs names: ETH0RXPKT
#define	R_ETH0_ARPRX      	0x08000924	// 08000900, wbregs names: ETH0ARPRX
#define	R_ETH0_ICMPRX     	0x08000928	// 08000900, wbregs names: ETH0ICMRX
#define	R_ETH0_TXPKTS     	0x0800092c	// 08000900, wbregs names: ETH0TXPKT
#define	R_ETH0_ARPTX      	0x08000930	// 08000900, wbregs names: ETH0ARPTX
#define	R_ETH0_ICMPTX     	0x08000934	// 08000900, wbregs names: ETH0ICMTX
#define	R_ETH0_DATATX     	0x08000938	// 08000900, wbregs names: ETH0DATTX
#define	R_ETH0_TXABORTS   	0x0800093c	// 08000900, wbregs names: ETH0ABRTS
#define	R_ETH0_DBGRX      	0x08000940	// 08000900, wbregs names: ETH0DBGRX
#define	R_ETH0_DBGTX      	0x08000944	// 08000900, wbregs names: ETH0DBGTX
// I2C Controller registers
#define	R_I2CCPU          	0x08000a00	// 08000a00, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW      	0x08000a04	// 08000a00, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR     	0x08000a08	// 08000a00, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT  	0x08000a0c	// 08000a00, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA          	0x08000a40	// 08000a40, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR     	0x08000a44	// 08000a40, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE     	0x08000a48	// 08000a40, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN      	0x08000a4c	// 08000a40, wbregs names: I2CDMALEN
// SYSCLK Clock Counter (measures clock speed)
#define	R_ADCCLK          	0x08000a80	// 08000a80, wbregs names: ADCCLK
#define	R_BLDTIME         	0x08000a84	// 08000a84, wbregs names: BLDTIME, BUILDTIME
#define	R_PIC             	0x08000a88	// 08000a88, wbregs names: PIC
#define	R_PWRCOUNT        	0x08000a8c	// 08000a8c, wbregs names: PWRCOUNT
#define	R_RTCCOUNT        	0x08000a90	// 08000a90, wbregs names: RTCCOUNT
// SYSCLK Clock Counter (measures clock speed)
#define	R_RXETH0CK        	0x08000a94	// 08000a94, wbregs names: RXETH0CK
#define	R_SPIO            	0x08000a98	// 08000a98, wbregs names: SPIO
// SYSCLK Clock Counter (measures clock speed)
#define	R_TXCLK           	0x08000a9c	// 08000a9c, wbregs names: TXCLK
#define	R_VERSION         	0x08000aa0	// 08000aa0, wbregs names: VERSION
#define	R_DDR3_PHY        	0x08000c00	// 08000c00, wbregs names: DDR3_PHY, DPHYSTAT0
#define	R_DDR3_PHYSTAT1   	0x08000c04	// 08000c00, wbregs names: DDR3_PHYSTAT1, DPHYSTAT1
#define	R_DDR3_PHYSTAT2   	0x08000c08	// 08000c00, wbregs names: DDR3_PHYSTAT2, DPHYSTAT2
#define	R_DDR3_PHYSTAT3   	0x08000c0c	// 08000c00, wbregs names: DDR3_PHYSTAT3, DPHYSTAT3
#define	R_DDR3_PHYCTRLSTAT	0x08000c10	// 08000c00, wbregs names: DDR3_PHYCTRLSTAT, DCTRLSTAT
#define	R_DDR3_PHYRESET   	0x08000c44	// 08000c00, wbregs names: DDR3_PHYRESET, DCTRLRESET
#define	R_DDR3_PHYDBGSEL  	0x08000c4c	// 08000c00, wbregs names: DDR3_PHYDBGSEL, DCTRLDBG
