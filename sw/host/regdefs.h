...
//
// CmdLine:	autofpga -I / -d -o . allclocks.txt clkcheck.txt global.txt crossbus.txt icape.txt version.txt pic.txt pwrcount.txt rtccount.txt spio.txt exconsole.txt wbuuart.txt wbuarbiter.txt bkram.txt flash.txt flashcfg.txt mig.txt mem_sdram_only.txt mem_flash_sdram.txt migperf.txt zipmaster.txt mdio.txt meganet.txt protocols.txt eth0bus.txt sdio.txt ramscope.txt flashscope.txt mem_flash_bkram.txt mem_bkram_only.txt xdc.txt i2ccpu.txt
//
...
// ramscope compressed scope
#define	R_RAMSCOPE      	0x08000800	// 08000800, wbregs names: RAMSCOPE
#define	R_RAMSCOPED     	0x08000804	// 08000800, wbregs names: RAMSCOPED
// CONSOLE registers
#define	R_CONSOLE_FIFO  	0x08000a04	// 08000a00, wbregs names: UFIFO
#define	R_CONSOLE_UARTRX	0x08000a08	// 08000a00, wbregs names: RX, RXUART
#define	R_CONSOLE_UARTTX	0x08000a0c	// 08000a00, wbregs names: TX, TXUART
...
#define	R_I2CCPU        	0x08001000	// 08001000, wbregs names: I2CCPU, I2CCPU_CTRL, I2CCPUCTRL
#define	R_I2CCPU_OVW    	0x08001004	// 08001000, wbregs names: I2CCPU_OVW, I2CCPU_OVERRIDE
#define	R_I2CCPU_ADDR   	0x08001008	// 08001000, wbregs names: I2CCPU_ADDR, I2CCPU_ADDRESS
#define	R_I2CCPU_CKCOUNT	0x0800100c	// 08001000, wbregs names: I2CCPUCLK, I2CCPU_CKCOUNT
#define	R_I2CDMA        	0x08001040	// 08001040, wbregs names: I2CDMA
#define	R_I2CDMA_ADDR   	0x08001044	// 08001040, wbregs names: I2CDMAADDR
#define	R_I2CDMA_BASE   	0x08001048	// 08001040, wbregs names: I2CDMABASE
#define	R_I2CDMA_LEN    	0x0800104c	// 08001040, wbregs names: I2CDMALEN
// SYSCLK Clock Counter (measures clock speed)
#define	R_ADCCLK        	0x080010c0	// 080010c0, wbregs names: ADCCLK
#define	R_BLDTIME       	0x080010c4	// 080010c4, wbregs names: BLDTIME, BUILDTIME
#define	R_PIC           	0x080010c8	// 080010c8, wbregs names: PIC
#define	R_PWRCOUNT      	0x080010cc	// 080010cc, wbregs names: PWRCOUNT
#define	R_RTCCOUNT      	0x080010d0	// 080010d0, wbregs names: RTCCOUNT
// SYSCLK Clock Counter (measures clock speed)
#define	R_RXETH0CK      	0x080010d4	// 080010d4, wbregs names: RXETH0CK
#define	R_SPIO          	0x080010d8	// 080010d8, wbregs names: SPIO
// SYSCLK Clock Counter (measures clock speed)
#define	R_TXCLK         	0x080010dc	// 080010dc, wbregs names: TXCLK
#define	R_VERSION       	0x080010e0	// 080010e0, wbregs names: VERSION
// Ethernet configuration (MDIO) port
#define	R_MDIO_BMCR     	0x08002000	// 08002000, wbregs names: BMCR
#define	R_MDIO_BMSR     	0x08002004	// 08002000, wbregs names: BMSR
#define	R_MDIO_PHYIDR1  	0x08002008	// 08002000, wbregs names: PHYIDR1
#define	R_MDIO_PHYIDR2  	0x0800200c	// 08002000, wbregs names: PHYIDR2
#define	R_MDIO_ANAR     	0x08002010	// 08002000, wbregs names: ANAR
#define	R_MDIO_ANLPAR   	0x08002014	// 08002000, wbregs names: ANLPAR
#define	R_MDIO_ANER     	0x08002018	// 08002000, wbregs names: ANER
#define	R_MDIO_ANNPTR   	0x0800201c	// 08002000, wbregs names: ANNPTR
#define	R_MDIO_ANNPRR   	0x08002020	// 08002000, wbregs names: ANNPRR
#define	R_MDIO_GBCR     	0x08002024	// 08002000, wbregs names: GBCR
#define	R_MDIO_GBSR     	0x08002028	// 08002000, wbregs names: GBSR
#define	R_MDIO_MACR     	0x08002034	// 08002000, wbregs names: MACR
#define	R_MDIO_MAADR    	0x08002038	// 08002000, wbregs names: MAADR
#define	R_MDIO_GBESR    	0x0800203c	// 08002000, wbregs names: GBESR
#define	R_MDIO_PHYCR    	0x08002040	// 08002000, wbregs names: PHYCR
#define	R_MDIO_PHYSR    	0x08002044	// 08002000, wbregs names: PHYSR
#define	R_MDIO_INER     	0x08002048	// 08002000, wbregs names: INER
#define	R_MDIO_INSR     	0x0800204c	// 08002000, wbregs names: INSR
#define	R_MDIO_RXERC    	0x08002060	// 08002000, wbregs names: RXERC
#define	R_MDIO_LDPSR    	0x0800206c	// 08002000, wbregs names: LDPSR
#define	R_MDIO_EPAGSR   	0x08002078	// 08002000, wbregs names: EPAGSR
#define	R_MDIO_PAGSEL   	0x0800207c	// 08002000, wbregs names: PAGSEL
#define	R_XMDIO_PC1R    	0x08002000	// 08002000, wbregs names: XPC1R
#define	R_XMDIO_PS1R    	0x08002004	// 08002000, wbregs names: XPS1R
#define	R_XMDIO_EEECR   	0x08002050	// 08002000, wbregs names: XEEECR
#define	R_XMDIO_EEEWER  	0x08002040	// 08002000, wbregs names: XEEEWER
#define	R_XMDIO_EEEAR   	0x080020f0	// 08002000, wbregs names: XEEEAR
#define	R_XMDIO_EEELPAR 	0x080020f4	// 08002000, wbregs names: XEEELPAR
#define	R_XMDIO_LACR    	0x08002068	// 08002000, wbregs names: XLACR
#define	R_XMDIO_LCR     	0x08002070	// 08002000, wbregs names: XLCR
