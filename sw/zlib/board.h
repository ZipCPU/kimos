...
#define	WBPERF_START		1
#define	WBPERF_STOP		0
#define	WBPERF_CLEAR		2
#define	WBPERF_TRIGGERED	4
#define	WBPERF_ERR		8

typedef	struct WBPERF_S {
	unsigned	p_active, p_stb, p_stall, p_stb_ack, p_stall_ack,
			p_simple_acks, p_wait, p_hold, p_tail, p_buserr,
			p_busabort, p_bytes, p_write_bytes, p_write_beats,
			p_numcyc;
	unsigned	p_control;
} WBPERF;
...
static volatile I2CCPU *const _i2c=((I2CCPU *)0x08000a00);
#endif	// I2CCPU_ACCESS
#ifdef	I2CDMA_ACCESS
#define	_BOARD_HAS_I2CDMA
static volatile I2CDMA *const _i2cdma=((I2CDMA *)0x08000a40);
#endif	// I2CDMA_ACCESS
#ifdef	RAMSCOPE_SCOPC
#define	_BOARD_HAS_RAMSCOPE
static volatile WBSCOPE *const _ramscope = ((WBSCOPE *)0x08000600);
...
static volatile unsigned *const _spio = ((unsigned *)0x08000a98);
#endif	// SPIO_ACCESS
#define	_BOARD_HAS_RTCCOUNT
static volatile unsigned *const _rtccount = ((unsigned *)0x08000a90);
#ifdef	PWRCOUNT_ACCESS
static volatile unsigned *const _pwrcount = ((unsigned *)0x08000a8c);
...
static volatile unsigned *const _version = ((unsigned *)0x08000aa0);
#endif	// VERSION_ACCESS
#ifdef	ETH0_ACCESS
#define	_BOARD_HAS_ETH0
static volatile ENETSTREAM *const io_eth0 = ((ENETSTREAM *)0x08000900);
#endif	// ETH0_ACCESS
#ifdef	TXCLK
static volatile unsigned *const _txclk = ((unsigned *)0x08000a9c);
#endif	// TXCLK
#define	_BOARD_HAS_BLDTIME
static volatile unsigned *const _buildtime = ((unsigned *)0x08000a84);
...
#ifdef	RXETH0CK
static volatile unsigned *const _rxeth0ck = ((unsigned *)0x08000a94);
#endif	// RXETH0CK
#ifdef	ADCCLK
static volatile unsigned *const _adcclk = ((unsigned *)0x08000a80);
#endif	// ADCCLK
#ifdef	FLASH_ACCESS
...
static volatile CONSOLE *const _uart = ((CONSOLE *)0x08000700);
...
static volatile DDR3_PHY *const _ddr3_phy = ((DDR3_PHY *)0x08000c00);
...
#endif	// SDRAM_ACCESS
#ifdef	WBPERF_ACCESS
#define	_BOARD_HAS_WBPERF
static volatile WBPERF *const _wbperf = ((WBPERF *)0x08000ac0);
#endif	// WBPERF_ACCESS
#ifdef	BUSPIC_ACCESS
#define	_BOARD_HAS_BUSPIC
static volatile unsigned *const _buspic = ((unsigned *)0x08000a88);
#endif	// BUSPIC_ACCESS
//
