...
`define	TXCLK
`endif	// ALLCLOCKS_PRESENT
// Deplist for @$(PREFIX)=ddr3scope
`ifdef	SDRAM_ACCESS
`define	DDR3SCOPE_SCOPC
`endif	// SDRAM_ACCESS
...
// }}}
	...
	//
	wire	ddr3scope_int;	// ddr3scope.INT.DDR3SCOPE.WIRE
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component ddr3scope
	// Verilator lint_off UNUSED
	wire		wb32_ddr3scope_cyc, wb32_ddr3scope_stb, wb32_ddr3scope_we;
	wire	[10:0]	wb32_ddr3scope_addr;
	wire	[31:0]	wb32_ddr3scope_data;
	wire	[3:0]	wb32_ddr3scope_sel;
	wire		wb32_ddr3scope_stall, wb32_ddr3scope_ack, wb32_ddr3scope_err;
	wire	[31:0]	wb32_ddr3scope_idata;
	// Verilator lint_on UNUSED
	...
	assign	wb32_ddr3scope_err= 1'b0;
...
`ifdef	DDR3SCOPE_SCOPC
	...
	wbscopc #(
		...
		.i_trigger(ddr3_debug[31]), .i_data(ddr3_debug[30:0]),
		.i_wb_clk(i_clk),
		.i_wb_cyc(wb32_ddr3scope_cyc), .i_wb_stb(wb32_ddr3scope_stb), .i_wb_we(wb32_ddr3scope_we),
			.i_wb_addr(wb32_ddr3scope_addr[1-1:0]),
			.i_wb_data(wb32_ddr3scope_data), // 32 bits wide
			.i_wb_sel(wb32_ddr3scope_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_ddr3scope_stall),.o_wb_ack(wb32_ddr3scope_ack), .o_wb_data(wb32_ddr3scope_idata),
		.o_interrupt(ddr3scope_int)
		// }}}
	);
	// }}}
`else	// DDR3SCOPE_SCOPC
	// {{{
	// Null bus slave
	// {{{

	//
	// In the case that there is no wb32_ddr3scope peripheral
	// responding on the wb32 bus
	assign	wb32_ddr3scope_ack   = 1'b0;
	assign	wb32_ddr3scope_err   = (wb32_ddr3scope_stb);
	assign	wb32_ddr3scope_stall = 0;
	assign	wb32_ddr3scope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	ddr3scope_int = 1'b0;	// ddr3scope.INT.DDR3SCOPE.WIRE
	// }}}
	// }}}
`endif	// DDR3SCOPE_SCOPC
