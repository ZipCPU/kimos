...
`endif
	...
	localparam SDRAMROW_BITS = 14,  // width of row address
		...
		SDRAMAUX_WIDTH = 16, //width of aux line (must be >= 4) 
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32(DIO), component wbperf
	// Verilator lint_off UNUSED
	wire		wb32_wbperf_cyc, wb32_wbperf_stb, wb32_wbperf_we;
	wire	[10:0]	wb32_wbperf_addr;
	wire	[31:0]	wb32_wbperf_data;
	wire	[3:0]	wb32_wbperf_sel;
	wire		wb32_wbperf_stall, wb32_wbperf_ack, wb32_wbperf_err;
	wire	[31:0]	wb32_wbperf_idata;
	// Verilator lint_on UNUSED
...
`endif	// BKRAM_ACCESS
	// info: @ERROR.WIRE ddr3_err != wbwide_ddr3
	// info: @ERROR.WIRE for ddr3, = ddr3_err, doesn't match the buses wire wbwide_ddr3_err
	assign	wbwide_ddr3_err = ddr3_err; // Z
	//
	...
	2'd3: r_wb32_dio_data <= wb32_wbperf_idata;
	endcase
	...
	assign	wb32_sio_stb = wb32_dio_stb && ((wb32_dio_addr[ 5: 4] &  2'h3) ==  2'h2);  // 0x080 - 0x0bf
	...
	assign	wb32_wbperf_cyc = wb32_dio_cyc;
	assign	wb32_wbperf_stb = wb32_dio_stb && ((wb32_dio_addr[ 5: 4] &  2'h3) ==  2'h3);  // 0x0c0 - 0x0ff
	assign	wb32_wbperf_we  = wb32_dio_we;
	assign	wb32_wbperf_addr= wb32_dio_addr;
	assign	wb32_wbperf_data= wb32_dio_data;
	assign	wb32_wbperf_sel = wb32_dio_sel;
...
`ifdef	SDRAM_ACCESS
	...
	ddr3_controller #(
		...
		.o_wb_stall(wbwide_ddr3_stall),.o_wb_ack(wbwide_ddr3_ack), .o_wb_data(wbwide_ddr3_idata), .o_wb_err(wbwide_ddr3_err),
		.i_aux(0),
		...
		.o_calib_complete(ign_ddr3_calib_complete),
...
`ifdef	WBPERF_ACCESS
	...
	wbperf	#(
		...
		// {{{
		.i_clk(i_clk), .i_reset(i_reset),
		.i_wb_cyc(wb32_wbperf_cyc), .i_wb_stb(wb32_wbperf_stb), .i_wb_we(wb32_wbperf_we),
			.i_wb_addr(wb32_wbperf_addr[4-1:0]),
			.i_wb_data(wb32_wbperf_data), // 32 bits wide
			.i_wb_sel(wb32_wbperf_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_wbperf_stall),.o_wb_ack(wb32_wbperf_ack), .o_wb_data(wb32_wbperf_idata),
		.i_mon_cyc(wbwide_ddr3_cyc),
		.i_mon_stb(wbwide_ddr3_stb),
		.i_mon_we(wbwide_ddr3_we),
		.i_mon_sel(wbwide_ddr3_sel),
		.i_mon_stall(wbwide_ddr3_stall),
		.i_mon_ack(wbwide_ddr3_ack),
		.i_mon_err(wbwide_ddr3_err)
		// }}}
	);
