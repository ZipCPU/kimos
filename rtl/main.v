...
`define	TXCLK
`endif	// ALLCLOCKS_PRESENT
// Deplist for @$(PREFIX)=wb2axiscope
`ifdef	SDRAM_ACCESS
`define	AXIDBG_SCOPC
`endif	// SDRAM_ACCESS
...
// }}}
	...
	//
	wire	wb2axiscope_int;	// wb2axiscope.INT.SDIOSCOPE.WIRE
...
// }}}
	...
	// Verilator lint_on UNUSED
	// Wishbone definitions for bus wb32, component wb2axiscope
	// Verilator lint_off UNUSED
	wire		wb32_wb2axiscope_cyc, wb32_wb2axiscope_stb, wb32_wb2axiscope_we;
	wire	[10:0]	wb32_wb2axiscope_addr;
	wire	[31:0]	wb32_wb2axiscope_data;
	wire	[3:0]	wb32_wb2axiscope_sel;
	wire		wb32_wb2axiscope_stall, wb32_wb2axiscope_ack, wb32_wb2axiscope_err;
	wire	[31:0]	wb32_wb2axiscope_idata;
	// Verilator lint_on UNUSED
	...
	assign	wb32_wb2axiscope_err= 1'b0;
...
`ifdef	AXIDBG_SCOPC
	...
	wbscopc #(
		...
		.i_trigger(i_sdram_dbg[31]), .i_data(i_sdram_dbg[30:0]),
		.i_wb_clk(i_clk),
		.i_wb_cyc(wb32_wb2axiscope_cyc), .i_wb_stb(wb32_wb2axiscope_stb), .i_wb_we(wb32_wb2axiscope_we),
			.i_wb_addr(wb32_wb2axiscope_addr[1-1:0]),
			.i_wb_data(wb32_wb2axiscope_data), // 32 bits wide
			.i_wb_sel(wb32_wb2axiscope_sel),  // 32/8 bits wide
		.o_wb_stall(wb32_wb2axiscope_stall),.o_wb_ack(wb32_wb2axiscope_ack), .o_wb_data(wb32_wb2axiscope_idata),
		.o_interrupt(wb2axiscope_int)
		// }}}
	);
	// }}}
`else	// AXIDBG_SCOPC
	...
	//
	// In the case that there is no wb32_wb2axiscope peripheral
	// responding on the wb32 bus
	assign	wb32_wb2axiscope_ack   = 1'b0;
	assign	wb32_wb2axiscope_err   = (wb32_wb2axiscope_stb);
	assign	wb32_wb2axiscope_stall = 0;
	assign	wb32_wb2axiscope_idata = 0;

	// }}}
	// Null interrupt definitions
	// {{{
	assign	wb2axiscope_int = 1'b0;	// wb2axiscope.INT.SDIOSCOPE.WIRE
	// }}}
	// }}}
`endif	// AXIDBG_SCOPC
